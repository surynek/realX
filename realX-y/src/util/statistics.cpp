...
/*============================================================================*/
<<<<<<< HEAD
/* statistics.cpp / 0-113_nofutu                                              */
=======
/* statistics.cpp / 0-111_nofutu                                              */
>>>>>>> 3587ec488605672e51133d66eff0e092dcb9204c
/*----------------------------------------------------------------------------*/
//
...
/*----------------------------------------------------------------------------*/
	...
	, m_WC_Seconds(0.0)
	, m_CPU_Seconds(0.0)
	, m_counterexample_Refinements(0)
...
/*----------------------------------------------------------------------------*/
	...
	fprintf(output, "%s%s%sCounterexample refinements     = %lld\n", indent.c_str(), s_INDENT.c_str(), s_INDENT.c_str(), phase.m_counterexample_Refinements);
